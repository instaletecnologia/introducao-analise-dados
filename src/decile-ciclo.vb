Sub CalcularDecilesCiclo()
    ...
    ' Defina a planilha
    Set ws = ThisWorkbook.Sheets("DADOS") 'Trocar aqui caso sa aba de dados tenha outro nome
...
End If
    ...
    ' Classifique os dados da coluna "Ciclo" baseado nos segundos
    i = 1
    For Each cell In cicloRange
        For j = 1 To 10
